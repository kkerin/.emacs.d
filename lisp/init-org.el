...
(use-package org
  ...
  (add-to-list 'org-capture-templates
               '("tr" "Book Reading Task" entry
                 (file+olp "~/Nutstore/org/task.org" "Reading" "Book")
                 "* TODO %^{书名}\n%u\n" :clock-in t))
  (add-to-list 'org-capture-templates
               '("tw" "Work Task" entry
                 (file+headline "~/Nutstore/org/task.org" "Work")
                 "* TODO %^{任务名}\n%u\n" :clock-in t))
  (add-to-list 'org-capture-templates
               '("j" "Journal" plain
                 (file+datetree "~/Nutstore/org/journal.org")" %?"))
  (add-to-list 'org-capture-templates
               '("i" "Inbox" entry (file "~/Nutstore/org/inbox.org")
                 "* %U - %^{heading} %^g\n %?\n"))
  (add-to-list 'org-capture-templates
               '("n" "Notes" entry (file "~/Nutstore/org/notes.org")
                 "* %^{heading} %t %^g\n  %?\n"))
  ;;org-agenda
  (setq org-agenda-files '("~/Nutstore/org/task.org")
